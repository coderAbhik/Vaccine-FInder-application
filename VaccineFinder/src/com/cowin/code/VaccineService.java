    ...
    public boolean isAvailable() {
       ...
       // String pincode = sc.nextLine();
        ...
        HttpGet request = new HttpGet(
                "https://cdn-api.co-vin.in/api/v2/appointment/sessions/public/calendarByPin?pincode=201005&date=24-05-2021");
        ...
        try (CloseableHttpResponse response = httpClient.execute(request)) {
            ...
            if (entity != null) {
                ...
                System.out
                        .println(isAvailable ? "available hai !!! lagwa le.. "
                                : "nahi hai bhai tu ese hi marega bina vaccine !!");
                return isAvailable;
            }
